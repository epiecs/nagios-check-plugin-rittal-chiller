 ...
 * You can test with
 *
 * php php5/check_rittal_chiller.php -H 10.1.31.193 -C coldairtemp -W 30 -M 45
 * php php5/check_rittal_chiller.php -H 10.1.31.193 -C hotairtemp -W 30 -M 45
 * php php5/check_rittal_chiller.php -H 10.1.31.193 -C fanspeedrpm -W 2200 -M 3300
 * php php5/check_rittal_chiller.php -H 10.1.31.193 -C fanspeedpercentage -W 60 -M 90
 *
...
$checkRittalChiller->check(getopt("hC:H:W:M:", array("help")));
...
class checkRittalChiller
{
    ...
    /**
     * Checks the fan speed values of the chiller in rpm or percentage
    ...
    private function checkAirTemp($temperature, $warningTemperature, $maxTemperature)
    {
    ...
    private function checkFanSpeed($fanSpeed, $measuringUnit, $warningFanSpeed, $maxFanSpeed)
    {
    ...
    private function checkWebinterface($thttpdStatus)
    {
        switch ($thttpdStatus)
        {
                case 0:
